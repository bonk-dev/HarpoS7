...
public class LegacyAuthenticationSchemeTests
{
    ...
    [TestCase(
        ...
        new byte[] { 0x35, 0x35, 0x25, 0x2D, 0x2D } // Key2, Key1, IV, Transform6 (2x)
    )]
    ...
    [TestCase(
        new byte[]
        {
            
        },
        new byte[]
        {
            0x27, 0x13, 0x6B, 0x09, 0x19, 0x00, 0x8C, 0x5C, 0xBE, 0xC1, 0x35, 0x29,
            0xB7, 0x7F, 0xDD, 0x2B, 0x90, 0x54, 0x31, 0xA0, 0x24, 0x16, 0x7E, 0x54
        },
        new byte[]
        {
            0x45, 0xEF, 0xCD, 0xAB, 0xFF, 0xEE, 0xDD, 0xCC, 0xBB, 0xAA, 0x99, 0x88,
            0x77, 0x66, 0x55, 0x44, 0x33, 0x22, 0x00, 0x11
        }, 
        new byte[CommonConstants.PublicKeyLengthRealPlc] {
            0xE0, 0xE1, 0xF0, 0x4A, 0x5C, 0xA3, 0xF9, 0x01,
            0x48, 0x17, 0x86, 0x89, 0xBD, 0x0C, 0x93, 0x0A,
        ...
        new byte[] { 0x35, 0x99, 0x25, 0x2D, 0x2D } // Key2, Key1, IV, Transform6 (2x)
    )]
